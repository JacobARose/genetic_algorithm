#https://github.com/nfmcclure/tensorflow_cookbook/blob/master/11_More_with_TensorFlow/02_Working_with_a_Genetic_Algorithm/02_genetic_algorithm.py
    


# [source file](https://github.com/nfmcclure/tensorflow_cookbook/blob/master/11_More_with_TensorFlow/02_Working_with_a_Genetic_Algorithm/02_genetic_algorithm.py)
